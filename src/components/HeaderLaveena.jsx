            ...
            <div>
              <ul className=" space-y-2 py-3">
                <li className=" pb-2.5 pt-2.5">
                  <span className="px-5 text-white">Home</span></li>
                <li className=" pb-2.5 pt-2.5">
                  <span className="px-5 text-white">Product</span></li>
                <li className=" pb-2.5 pt-2.5">
                  <span className="px-5 text-white">Blog</span></li>
                <li className=" pb-2.5 pt-2.5">
                  <span className="px-5 text-white">About Us</span> </li>
                <li className=" pb-2.5 pt-2.5">
                  <span className="px-5 text-white">Contact Us</span> </li>
              </ul>
            </div>
          </div>
        </Popover.Panel>
